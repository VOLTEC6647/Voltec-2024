...
// Modified by Juan Pablo Gutiérrez
...
public class AutoAlignController {
    private static final LoggedTunableNumber linearkP = new LoggedTunableNumber("AutoAlign/drivekP", 1.5);
    private static final LoggedTunableNumber linearkD = new LoggedTunableNumber("AutoAlign/drivekD", 0.0);
    private static final LoggedTunableNumber thetakP = new LoggedTunableNumber("AutoAlign/thetakP", 5.0);
    ...
    private final AndromedaSwerve swerve;
    ...
    public AutoAlignController(Supplier<Pose2d> poseSupplier, boolean slowMode, AndromedaSwerve swerve) {
    ...
    private void resetControllers() {
        ...
        Twist2d fieldVelocity = new Twist2d(swerve.getFieldRelativeChassisSpeeds().vxMetersPerSecond,
                swerve.getFieldRelativeChassisSpeeds().vyMetersPerSecond,
                swerve.getFieldRelativeChassisSpeeds().omegaRadiansPerSecond);
    ...
    public ChassisSpeeds update() {
        ...
        lastSetpointTranslation = new Pose2d(
                ...
                .transformBy(com.andromedalib.math.GeomUtil.toTransform2d(linearController.getSetpoint().position, 0.0))
                .getTranslation();
