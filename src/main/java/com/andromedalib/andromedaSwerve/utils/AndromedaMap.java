...
public class AndromedaMap {
        ...
        public static final Rotation2d mod1Angleoffset = Rotation2d.fromRotations(0.087402); //0.553
        ...
        public static final Rotation2d mod2Angleoffset = Rotation2d.fromRotations(-0.474854); //3.540
        ...
        public static final Rotation2d mod3Angleoffset = Rotation2d.fromRotations(0.476807); //0.902;
        ...
        public static final Rotation2d mod4Angleoffset = Rotation2d.fromRotations(0.181885); //6.194
