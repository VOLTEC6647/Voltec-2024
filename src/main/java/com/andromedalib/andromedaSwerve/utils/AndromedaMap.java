...
public class AndromedaMap {
        ...
        public static final Rotation2d mod1Angleoffset = Rotation2d.fromRotations(0.088379); //0.553
        ...
        public static final Rotation2d mod2Angleoffset = Rotation2d.fromRotations(0.025635 ); //3.540
        ...
        public static final Rotation2d mod3Angleoffset = Rotation2d.fromRotations(0.025635); //0.902;
        ...
        public static final Rotation2d mod4Angleoffset = Rotation2d.fromRotations(0.196289); //6.194
