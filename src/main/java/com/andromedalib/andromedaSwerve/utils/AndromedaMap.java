...
public class AndromedaMap {
        ...
        public static final Rotation2d mod1Angleoffset = Rotation2d.fromRotations(0.091553); //0.553
        ...
        public static final Rotation2d mod2Angleoffset = Rotation2d.fromRotations(-0.476562); //3.540
        ...
        public static final Rotation2d mod3Angleoffset = Rotation2d.fromRotations(0.462158); //0.902;
        ...
        public static final Rotation2d mod4Angleoffset = Rotation2d.fromRotations(0.195068); //6.194
